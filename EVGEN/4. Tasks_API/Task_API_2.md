...
Создадим GET-запрос, который сразу получает информацию об 11 и 22м эпизодах: **curl "https://rickandmortyapi.com/api/episode/11,22"**

```bash
C:\Users\Evgeny>curl "https://rickandmortyapi.com/api/episode/11,22"
...
В ответ мы получили МАССИВ объектов, поскольку мы запросили информацию, не об одном эпизоде, а о двух:
...
Информация по **11му эпизоду**:

- **ID:** 11;

- **Название:** "Ricksy Business" (Рикси-бизнес);

- **Дата выхода:** 14 апреля 2014 года;

- **Серия:** S01E11 (11-я серия 1-го сезона);

- **Количество персонажей:** 30 персонажей;

- **Создан в API:** 10 ноября 2017 года;

Информация по **эпизоду 22**:

- **ID:** 22;

- **Название:** "The Rickshank Rickdemption" (Рикшэнк Риксимпция - игра слов с "The Shawshank Redemption");

- **Дата выхода:** 1 апреля 2017 года;

- **Серия:** S03E01 (1-я серия 3-го сезона);

- **Количество персонажей:** 44 персонажа;

- **Создан в API:** 10 ноября 2017 года;

Формируем GET запрос, который получит информацию о Пост-Апокалиптической Земле: **curl "https://rickandmortyapi.com/api/location/?name=Post-Apocalyptic%20Earth"**

```bash
C:\Users\Evgeny>curl "https://rickandmortyapi.com/api/location/?name=Post-Apocalyptic%20Earth"
...
- **Название:** "Post-Apocalyptic Earth" (Пост-Апокалиптическая Земля)

- **Тип:** Planet (Планета)

- **Измерение:** "Post-Apocalyptic Dimension" (Пост-Апокалиптическое измерение)
